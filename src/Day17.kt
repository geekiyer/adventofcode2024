...
private data class Operand(val id: Int) {
    ...
    fun getComboValue(state: CurrentState): Long = when (id) {
...
private fun findPossibleStarting(registerA: Long, expectedOutput: Long, state: CurrentState): List<Long> {
...
fun solve1(input: String): String {
    ...
    val state = CurrentState(registers, instructions)
